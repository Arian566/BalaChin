...
public class PresetRadioGroupAni extends LinearLayout {
    ...
    public PresetRadioGroupAni(Context context) {
        super(context);
        setupView();
    }

    public PresetRadioGroupAni(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public PresetRadioGroupAni(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public PresetRadioGroupAni(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void parseAttributes(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs,
                R.styleable.PresetRadioGroupAni, 0, 0);
        try {
            mCheckedId = a.getResourceId(R.styleable.PresetRadioGroupAni_presetRadioCheckedIdAni, View.NO_ID);
    ...
    private class PassThroughHierarchyChangeListener implements
        ...
        public void onChildViewAdded(View parent, View child) {
            if (parent == PresetRadioGroupAni.this && child instanceof RadioCheckable) {
                int id = child.getId();
