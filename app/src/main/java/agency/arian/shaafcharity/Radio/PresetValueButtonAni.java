package agency.arian.shaafcharity.Radio;
...
public class PresetValueButtonAni extends RelativeLayout implements RadioCheckable {
    // Views
    ...
    public PresetValueButtonAni(Context context) {
        super(context);
        setupView();
    }

    public PresetValueButtonAni(Context context, AttributeSet attrs) {
        super(context, attrs);
    ...
    public PresetValueButtonAni(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    public PresetValueButtonAni(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
    ...
    private void parseAttributes(AttributeSet attrs) {
        TypedArray a = getContext().obtainStyledAttributes(attrs,
                R.styleable.PresetValueButtonAni, 0, 0);
        Resources resources = getContext().getResources();
        try {
            mValue = a.getString(R.styleable.PresetValueButtonAni_presetButtonValueTextAni);
            mUnit = a.getString(R.styleable.PresetValueButtonAni_presetButtonUnitTextAni);
            mValueTextColor = a.getColor(R.styleable.PresetValueButtonAni_presetButtonValueTextColorAni, resources.getColor(R.color.black));
            mPressedTextColor = a.getColor(R.styleable.PresetValueButtonAni_presetButtonPressedTextColorAni, Color.WHITE);
            mUnitTextColor = a.getColor(R.styleable.PresetValueButtonAni_presetButtonUnitTextColorAni, resources.getColor(R.color.gray));
        } finally {
            a.recycle();
        }
    }
